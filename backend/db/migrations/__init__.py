...
from .add_terraform_management_tables import run_migration as run_terraform_management_migration
from backend.db.session import DEFAULT_DB_PATH

# Legacy profile column helper kept here to avoid circular imports with backend.db
...
__all__ = ["ensure_user_profile_columns", "run_terraform_management_migration"]
